    ...
    for j in range(0, len(batch_sizes)):
        for i in range(0, len(num_layers)):
            ...
            if layers == 4:  # (conv + pool + 2 * fc)
                conv_0 = Conv2D(num_filters, kernel_size=(default_filter_size, embedding_dim), padding='valid',
                                kernel_initializer='normal', activation='relu')(reshape)
                maxpool_0 = MaxPool2D(pool_size=(sequence_length - default_filter_size + 1, 1), strides=(1, 1),
                ...
                conv_1 = Conv2D(num_filters, kernel_size=(default_filter_size, embedding_dim - default_filter_size),
                ...
                conv_2 = Conv2D(num_filters, kernel_size=(default_filter_size, embedding_dim - 2 * default_filter_size),
                                padding='valid', kernel_initializer='normal', activation='relu')(maxpool_1)
                maxpool_2 = MaxPool2D(pool_size=(sequence_length - 3 * default_filter_size + 1, 1), strides=(1, 1),
                ...
                conv_3 = Conv2D(num_filters, kernel_size=(default_filter_size, embedding_dim - 3 * default_filter_size),
                                padding='valid', kernel_initializer='normal', activation='relu')(maxpool_2)
                maxpool_3 = MaxPool2D(pool_size=(sequence_length - 4 * default_filter_size + 1, 1), strides=(1, 1),
